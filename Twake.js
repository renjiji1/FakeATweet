...
function Done() {
    ...
    if (document.getElementById("done").checked) {
        ...
        let TweetImage = document.getElementById("tweetImg");
        if (TweetImage.getAttribute('src') == "ImageIcon.gif") {
            TweetImage.style.visibility = "hidden";
            document.getElementById("tweetImgDiv").style.height = "0";
        }
        console.log(TweetImage.src);
        let txt = document.getElementsByName("txt");
        for (i = 0; i < txt.length; i++) {
        ...
        document.getElementById("tweetImgDiv").style.height = "auto";
    }
}
